    ...
    def save_recurse_as_text(self, text_dir, apk_name):
        ...
        for entry_point, entry_point_data in self.results.items():
            ...
            if len(entry_point_data["children"]) == 1:
                ...
                print(f"Entry point data children: {entry_point_data['children']}")
                for child_function_name, child_summary in entry_point_data["children"].items():
                    print(f"Child function name: {child_function_name}")
                    print(f"Child summary: {child_summary}")
