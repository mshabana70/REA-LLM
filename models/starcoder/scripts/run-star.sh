...
singularity exec --nv \
        ...
        /bin/bash -c "source /ext3/env.sh; conda activate starcoder-env; python /scratch/ms9761/rea-llm/starcoder/src/recurse.py > /scratch/ms9761/rea-llm/starcoder/logs/${filename}"
