...
singularity exec --nv \
        ...
        /bin/bash -c "source /ext3/env.sh; conda activate llama-env; python /scratch/ms9761/rea-llm/starcoder/src/recurse_new.py > /scratch/ms9761/rea-llm/starcoder/logs/${filename}"
